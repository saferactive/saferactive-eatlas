...
This is a [geoplumber](https://github.com/ATFutures/geoplumber) app with scripts to run either as backend only, frontend only or as a Docker image for production.
